...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "sport",
            sa.Enum("BASEBALL", "BASKETBALL", "FOOTBALL", "HOCKEY", "SOCCER", name="sportenum"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "sport",
            sa.Enum("BASEBALL", "BASKETBALL", "FOOTBALL", "HOCKEY", "SOCCER", name="sport_enum"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_provider_sports_provider"), "provider_sports", ["provider"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.UniqueConstraint(
            "provider", "provider_league_id", name="uq_provider_leagues_provider_provider_league_id"
        ),
    )
    op.create_index(
        op.f("ix_provider_leagues_league_id"), "provider_leagues", ["league_id"], unique=False
    )
    op.create_index(
        op.f("ix_provider_leagues_provider"), "provider_leagues", ["provider"], unique=False
    )
    op.create_table(
        "seasons",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            "provider",
            sa.Enum("api_sports", "nflverse", "odds_api", name="providerenum"),
            server_default=sa.text("'api_sports'"),
            nullable=False,
        ),
